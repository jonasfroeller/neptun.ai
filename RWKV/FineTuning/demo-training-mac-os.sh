...
python train.py --load_model "RWKV-5-World-0.4B-v2-20231113-ctx4096.pth" --wandb "" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 ...
 --data_file "../../data/processed" --my_exit_tokens 1498226207 --magic_prime 2926181 \
 ...
 --accelerator gpu --devices $GPU_PER_NODE --precision bf16 --strategy deepspeed_stage_2 --grad_cp $GRAD_CP --ds_bucket_mb $DS_BUCKET_MB --enable_progress_bar
